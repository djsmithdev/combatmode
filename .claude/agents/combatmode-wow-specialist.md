...
- Respect **module ownership** from `.cursor/rules/combatmode-architecture-and-style.mdc`: put changes in the owning `Features/`, `Config/`, `Constants/`, or `UI/` file; avoid duplicating feature logic in config.
