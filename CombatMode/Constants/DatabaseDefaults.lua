...
CM.Constants.DatabaseDefaults = {
  global = {
    ...
    crosshairY = 100,
    crosshairImprovements = {
      enabled = true,
      colorNeutral = { r = 0.90, g = 0.90, b = 0.90, a = 0.50 },
      colorMelee = { r = 0.20, g = 1.00, b = 0.20, a = 0.90 },
      colorRanged = { r = 1.00, g = 0.80, b = 0.20, a = 0.90 },
      colorOutOfRange = { r = 1.00, g = 0.20, b = 0.20, a = 0.90 },
      colorHostile = { r = 1.00, g = 0.20, b = 0.30, a = 1.00 },
      colorFriendlyNPC = { r = 0.00, g = 1.00, b = 0.30, a = 0.80 },
      colorFriendlyPlayer = { r = 0.30, g = 0.60, b = 1.00, a = 0.80 },
      colorObject = { r = 1.00, g = 0.80, b = 0.20, a = 0.80 },
      colorBase = { r = 1.00, g = 1.00, b = 1.00, a = 0.50 },
      colorMounted = { r = 1.00, g = 1.00, b = 1.00, a = 0.00 },
      colorFocus = { r = 1.00, g = 0.20, b = 0.30, a = 1.00 },
      customSpells = {
        [1] = { id = false, color = { r = 1.00, g = 0.80, b = 0.20, a = 0.90 } },
        [2] = { id = false, color = { r = 0.20, g = 0.80, b = 1.00, a = 0.90 } },
        [3] = { id = false, color = { r = 0.80, g = 0.20, b = 1.00, a = 0.90 } },
      },
    },
    -- interaction HUD
    interactionHUD = true,
