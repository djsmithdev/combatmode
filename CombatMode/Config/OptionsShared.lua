---------------------------------------------------------------------------------------
--  Config/OptionsShared.lua — shared AceConfig builders (spacing, headers, groups)
---------------------------------------------------------------------------------------
--  Loaded before other Config/*Options.lua and Config.lua. Exposes CM.Config.OptionsUI for
