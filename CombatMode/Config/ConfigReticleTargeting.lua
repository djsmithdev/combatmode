...
CM.Config.ReticleTargetingOptions = {
  ...
  args = {
    ...
    reticleTargeting = {
      ...
      get = function() return CM.DB.char.reticleTargeting end
    },
    ...
    stickyCrosshair = {
      ...
      get = function() return CM.DB.char.stickyCrosshair end,
      disabled = function()
    ...
    excludeFromTargetingSpells = {
      ...
      desc =
      "Spells that you |cffE52B50DON'T|r want the |cffB47EDEtargeting macro conditionals|r applied to, thus not being able to select the crosshair unit.\n\n|cff909090Ex: Shield Wall, Ice Block, Divine Shield.|r\n\n|cffffd700Separate names with commas.|r\n|cffffd700Names are case insensitive.|r",
      type = "input",
      multiline = 6,
      width = "full",
      order = 6,
      set = function(_, value)
        CM.DB.char.excludeFromTargetingSpells =
            value and strtrim(value) or ""
    ...
    castAtCursorSpells = {
      ...
      desc =
      "|cff00ff00Ground-targeted|r abilities that you want cast with the |cffB47EDE@cursor|r modifier directly at the position of the crosshair without requiring the |cff00ff00green circle|r to be placed.\n\n|cff909090Ex: Heroic Leap, Shift, Blizzard.|r\n\n|cffffd700Separate names with commas.|r \n|cffffd700Names are case insensitive.|r",
      type = "input",
      multiline = 6,
      width = "full",
      order = 7,
