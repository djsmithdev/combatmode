    ...
    return {
        ...
        args = {
            ...
            button1macro = {
                ...
                desc = L["BUTTON_1_MACRO_DESC"], -- "Enter the name of the action you wish to be ran here."
                type = "input",
                width = 1.5,
                order = 1.3,
                set = function(_, value)
                ...
                disabled = function()
                    return not CM.DB.profile.bindings[button1Settings].enabled or
                               CM.DB.profile.bindings[button1Settings].value ~= "CUSTOMACTION"
                end
            },
            buttonbreak = {
                type = "description",
            ...
            button2macro = {
                ...
                disabled = function()
                    return not CM.DB.profile.bindings[button2Settings].enabled or
                               CM.DB.profile.bindings[button2Settings].value ~= "CUSTOMACTION"
                end
            }
        }
    }
...
CM.Options.DatabaseDefaults = {
    global = {
        version = "1.0.0",
        frameWatching = true,
        watchlist = {"SortedPrimaryFrame", "WeakAurasOptions"},
