...
5. **CombatMode/Core/ClickCasting/**, **FreeLook/**, **Crosshair/**, **AllyCycle/** — feature modules (see `Embeds.xml` for exact order). **Vignette.lua** loads after FreeLook (fades with Mouse Look).
